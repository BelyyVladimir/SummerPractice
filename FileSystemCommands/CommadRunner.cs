...
public class Program
{
    public static void Main()
    {
        ...
        var sizeCommand = (CommandLib.ICommand)Activator.CreateInstance(sizeCommandType, objects[0]);
        sizeCommand.Execute();
        ...
        var findCommand = (CommandLib.ICommand)Activator.CreateInstance(findCommandType, objects);
        findCommand.Execute();
